    ...
    <section className="py-20 relative overflow-hidden hero-section">
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-7xl font-bold font-display mb-6 animate-on-scroll animate-visible">
          ...
          <div className="flex flex-wrap justify-center gap-4 animate-on-scroll">
            ...
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-red-500 mr-2">
